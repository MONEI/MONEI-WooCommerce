...
/**
 * Money Clicktopay Gateway Settings.
 */
return apply_filters(
	'wc_monei_clicktopay_settings',
	array(
		'enabled'        => array(
			'title'   => __( 'Enable/Disable', 'monei' ),
			'type'    => 'checkbox',
			'label'   => __( 'Enable Click To Pay by MONEI', 'monei' ),
			'default' => 'no',
		),
		'title'          => array(
		...
		'description'    => array(
			...
			'default'     => __( 'Pay with Click To Pay, you will be redirected to Monei. Powered by MONEI', 'monei' ),
		),
		'hide_logo'        => array(
