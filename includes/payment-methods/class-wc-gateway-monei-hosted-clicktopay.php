...
/**
 * Class that handle Monei Click To Pay Payment method.
 *
 * Class WC_Gateway_Monei_Clicktopay
 */
class WC_Gateway_Monei_Clicktopay extends WC_Monei_Payment_Gateway_Hosted {

	const PAYMENT_METHOD = 'clickToPay';
	...
	public function __construct() {
		...
		$this->id = MONEI_GATEWAY_ID . '_clicktopay';
		$this->method_title  = __( 'MONEI - Click To Pay', 'monei' );
		$this->method_description = __( 'Accept Click To Pay payments.', 'monei' );
	...
	public function init_form_fields() {
        $this->form_fields = require WC_Monei()->plugin_path() . '/includes/admin/monei-clicktopay-settings.php';
	}
