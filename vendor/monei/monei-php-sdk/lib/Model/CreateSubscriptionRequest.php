...
class CreateSubscriptionRequest implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['trial_period_days'] = isset($data['trial_period_days']) ? $data['trial_period_days'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payment_callback_url'] === null) {
            $invalidProperties[] = "'payment_callback_url' can't be null";
        }
     ...
     * Sets callback_url
     *
     * @param string $callback_url The URL will be called each time subscription status changes.
     *
     * @return $this
     */
     ...
     *
     * @param string $payment_callback_url The URL will be called each time subscription creates a new payments.
     *
     * @return $this
     */
